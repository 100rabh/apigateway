...
describe('Tag e2e test', () => {
    ...
    it('should load Tags', () => {
        ...
        expect(tagComponentsPage.getTitle()).toMatch(/apigatewayApp.tag.home.title/);
    ...
    it('should load create Tag dialog', () => {
        ...
        expect(tagDialogPage.getModalTitle()).toMatch(/apigatewayApp.tag.home.createOrEditLabel/);
        tagDialogPage.close();
    });
