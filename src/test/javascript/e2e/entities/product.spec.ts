...
describe('Product e2e test', () => {
    ...
    it('should load Products', () => {
        ...
        expect(productComponentsPage.getTitle()).toMatch(/apigatewayApp.product.home.title/);
    ...
    it('should load create Product dialog', () => {
        ...
        expect(productDialogPage.getModalTitle()).toMatch(/apigatewayApp.product.home.createOrEditLabel/);
