...
describe('Blog e2e test', () => {
    ...
    it('should load Blogs', () => {
        ...
        expect(blogComponentsPage.getTitle()).toMatch(/apigatewayApp.blog.home.title/);
    ...
    it('should load create Blog dialog', () => {
        ...
        expect(blogDialogPage.getModalTitle()).toMatch(/apigatewayApp.blog.home.createOrEditLabel/);
